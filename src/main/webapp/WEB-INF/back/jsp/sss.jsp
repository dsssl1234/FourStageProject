...
<head>
    ...
    <script src="<%=request.getContextPath()%>/layui/layui.js"></script>
        <script src="${pageContext.request.contextPath}/back/js/jquery-3.4.1.js"></script>
<%--        <script src="${pageContext.request.contextPath}/js/json2.js"></script>--%>
    <script src="<%=request.getContextPath()%>/back/js/sss.js"></script>
    <style>
...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item"><a href="<%=request.getContextPath()%>/admin/deleteAdmin">退出</a></li>
        </ul>
    </div>
